...
1. Открываем Putty
2. Нажимаем Add Key
3. Выбираем сохранённый .ppk и закрываем окно
4. Нажимаем правой кнопкой на иконку Putty в трее и выбираем New Session
5. В поле "Host Name" вбиваем созранённый ранее IPv4 (158.160.142.17)
6. Нажимаем кнопку "Open"
7. В появившемся окне нажимаем "Accept"
8. В появившейся консоли в ответ на вопрос "login as" пишем ранее указанный в ВМ логин otus
