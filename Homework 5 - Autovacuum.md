...
---------+------------+------------+--------+-------------------------------
 mytable |    1001005 |          0 |      0 | 2024-03-27 23:53:13.323882+03
(1 row)
```
### Подождать некоторое время, проверяя, пришел ли автовакуум
Он успел прийти ещё на предыдущем шаге.
...
При обновлении записей каждый раз создаётся новая строка, а старая ждёт удаления, например, через autovacuum.  
Так как autovacuum отключен, старые строки остаются на диске и увеличивают размер таблицы.  
